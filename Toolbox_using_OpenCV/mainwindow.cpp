...
{
        int index0= ui->functionList->currentIndex();
        if (index0== 1){
            saltAndPepper(processedImage, 1000);
        }


            int index1 = ui->functionList_2->currentIndex();

            if(index1 == 1){
                 addLogo();
            }
         int index2 = ui->functionList_3->currentIndex();
         ...
         int index3 = ui->functionList_4->currentIndex();
         ...
         int index4= ui->functionList_5->currentIndex();
         ...
         int index5= ui->functionList_6->currentIndex();
         {
             if (index5==1){
                 cv::Mat result;
                 cvtColor(image,result, CV_BGR2GRAY);
     ...
     //            cv::Sobel(result,sobelY,CV_8U,1,0,3,0.4,128);
          ...
          int index6= ui->functionList_7->currentIndex();
          ...
          if(index6 ==2){
           ...
           int index7 = ui->functionList_8->currentIndex();
          ...
          if(index7== 1)
          {
           ...
           if(index7== 2){
            ...
            int index8= ui->functionList_9->currentIndex();
   ...
   //             cv::Mat result(image.size(),CV_8U,cv::Scalar(255));
          ...
          int index9= ui->functionList_10->currentIndex();
            if(index9 == 1){
